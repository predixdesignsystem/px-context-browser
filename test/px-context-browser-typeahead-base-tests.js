...
document.addEventListener("WebComponentsReady", function() {
  var contextBrowser1 = document.querySelector('#px_context_browser_1');
  var contextBrowser3 = document.querySelector('#px_context_browser_3');
  contextBrowser1.handlers = {
...
function runBaseTests() {
  ...
  px_context_browser_3 = document.getElementById('px_context_browser_3');

  px_context_browser_3.browserContext = browserContext;
  ...
  suite('Base Automation Tests for px-context-browser', function() {
    ...
    test('px-context-browser fixture is created', function() {
      assert.isTrue(document.getElementById('px_context_browser_3') !== null);
    });
